...
describe("E2E - Zakup diety lowCarb", () => {
    it("Proces zakupu", () => {
        cy.visit("/");
        ...
        //Kliknięcie w "Wybieram"  w zakładce "LowCarb" 1 miesiąc
        cy.get('[class="qczaj-price-list__navigation-tabs"]')
            .find(".qczaj-price-list__container")
            .find("a")
            .eq(2)
        ...
        cy.get('[class="qczaj-price-list__button JS-choose-button"]')
            .eq(2)
            .click();
        ...
        cy.get("#login").type("testowe_qczaj_lowcarb");
