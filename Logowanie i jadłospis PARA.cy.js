...
describe("E2E - Logowanie PARA", () => {
    it("Logowanie na konto", () => {
        ...
        //Postępy
        cy.get(".user-progress-container")
        ...
        cy.get(".user-progress-container")
        .find(".progress-bar-container")
        .find(".progress-bar-box")
        .find("p")
        .should("have.length", "6")
        .eq(1)
        .should("have.class", "start-weight");
        ...
        .should("have.length", "6")
        .eq(2)
        .should("have.class", "target-weight");

        cy.get(".user-progress-container")
        .find('[class="progress-bar-container partner"]')
        .find(".progress-bar-box")
        .find("p")
        ...
        //Karty: Razem / Partner1 / Partner2
        cy.get('[class="switch-for-couple"]')
        .find("button")
        .then(button => {
            expect(button).to.have.length(3)
        })
        .eq(0)
        .should("contain", "Razem")
        .and("have.class", "active together");
